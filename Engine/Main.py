...
#                                 collection_file_paths=["../ClassificationCollection"])
...
dataset_builder = DatasetBuilder(collection_file_paths=["../ClusteringCollection"])
print(max(dataset_builder.idf_dict.values()))
print(min(dataset_builder.idf_dict.values()))
...
# dataset_AlgorithmicTransparency = dataset_builder.build(dir_txt_files_path="../ClusteringDocs/AlgorithmicTransparency",\
#                                                                      list_files_names=dataset_builder.import_docs("../ClusteringDocs/AlgorithmicTransparency"),\
...
#                              dataset_AlgorithmicTransparency, dataset_FilterBubble, dataset_GenderBias])
#
# # shuffle the data frame
# concatenated_df = concatenated_df.sample(frac=1, random_state=1).reset_index()
#
